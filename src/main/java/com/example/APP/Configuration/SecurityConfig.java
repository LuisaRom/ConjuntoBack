    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/mensajes/contactos").hasAnyRole("ADMINISTRADOR", "CELADOR", "RESIDENTE")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/notificaciones/chat/**").hasAnyRole("ADMINISTRADOR", "CELADOR", "RESIDENTE")
                        .requestMatchers(HttpMethod.POST, "/api/notificaciones/chat/enviar").hasAnyRole("ADMINISTRADOR", "CELADOR", "RESIDENTE")
